...
emailNotificationType = Joi.string()
    .valid('newMatch', 'matchReminder', 'matchResult', "friendActivity")
...
pushNotificationType = Joi.string()
    .valid('newMatch', 'matchReminder', 'matchResult', "friendActivity", "homework")
